...
class ActivityStore {
  ...
  /**
   * Build the complete Activity request scope. Candidate discovery adds only
   * the clicked project fields to this object, so its range and filters cannot
   * drift from the report the user is looking at.
   */
  ...
  /** Refresh every surface changed by a reclassification mutation. */
