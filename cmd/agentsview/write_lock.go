...
// Held reports whether this owner currently holds the write lock. It is false
// between Release and Reacquire during a worker maintenance pass.
func (l *writeOwnerLock) Held() bool {
	return l != nil && l.lock != nil && l.lock.Locked()
}
