...
func TestFSEventsFlagMapping(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "MustScanSubDirs", flags: mustScanSubDirs, want: backendEvent{Op: backendOpFullSync}, relevant: true},
		{name: "UserDropped", flags: userDropped, want: backendEvent{Op: backendOpFullSync}, relevant: true},
		{name: "KernelDropped", flags: kernelDropped, want: backendEvent{Op: backendOpFullSync}, relevant: true},
		{name: "EventIdsWrapped", flags: eventIDsWrapped, want: backendEvent{Op: backendOpFullSync}, relevant: true},
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			got, relevant := translateFSEvent(root, fsevents.Event{
				Path:  path,
